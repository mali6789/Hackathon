...
const Footer4 = () => {
    return (
          <div className="w-full bg-[#F9F9F9] absolute top-[610px] lg:top-[744px] left-[-12px]">
          <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 h-[343px] w-full">
            {/* Logo & Text */}
             <div className="w-[350px] h-[198px] flex flex-col gap-[24px] absolute top-[100px] lg:top-[80px] left-[45px] lg:left-[300px]">
              <Image 
              src="/Logo.png" 
              alt="Logo" 
              className="mb-4" 
            ...
            {/* Newsletter */}
            <div className="w-[350px] absolute top-[600px] lg:top-[80px] left-[45px] lg:left-[1196px]">
