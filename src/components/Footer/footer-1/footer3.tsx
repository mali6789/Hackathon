...
const Footer3 = () => {
    return (
          <div className="w-full bg-[#F9F9F9] absolute top-[3950px] lg:top-[2016px] left-[-12px]">
          <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 h-[343px] w-full">
            ...
            {/* Newsletter */}
            <div className="w-[440px] absolute top-[600px] lg:top-[80px] left-[45px] lg:left-[1196px]">
          ...
          {/* Bottom Section */}
          <div className="mt-[440px] lg:mt-8 border-t border-gray-200 pt-4 text-center text-sm text-[#9A9CAA]">
