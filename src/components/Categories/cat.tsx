...
export default function TopCategories() {
    return (
        <div className="h-[508px] absolute top-[1867px] left-[-148px]">
            <div className="min-w-[1920px] h-[44px] absolute left-[148px] pt-[1250px] lg:py-0 px-[180px] pl-[100px] md:pl-[140px] lg:px-[300px] text-[32px] leading-[35.5px] text-left text-[#272343]">
                Top Categories
            </div>
