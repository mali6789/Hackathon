...
export default function NavbarLinks(){
    return(
        <div className="bg-white lg:h-[74px] lg:w-[1920px] flex justify-between items-center py-[14px] sm:px-[50px] lg:px-[300px]" style={{ boxShadow: '1px 1px 0px 0px #E1E3E5' }}>
             <div className="h-[15px] flex sm:gap-[20px] lg:gap-[32px] font-inter text-[14px] font-medium leading-[15.4px] text-left">
