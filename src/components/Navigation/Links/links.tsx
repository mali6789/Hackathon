...
export default function NavbarLinks(){
    return(
        <div className="bg-white lg:h-[74px] lg:w-full flex justify-between items-center py-[14px] px-[30px] md:px-[50px] lg:px-[300px]" style={{ boxShadow: '1px 1px 0px 0px #E1E3E5' }}>
