export default function TextBlock(){
    return(
        ...
        <div className="w-full lg:w-[672px] h-[478px] absolute lg:top-[303px] lg:left-[300px] bg-[#007580]">
            {/* Button*/}
            ...
            <div className="w-[495px] h-[161px] top-[64px] left-[64px] grid gap-[12px] absolute text-white">
                ...
                <div className="w-[400px] lg:w-full font-inter font-normal text-[18px] leading-[21.78px]">
