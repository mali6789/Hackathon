...
export default function Contact(){
    return (
        <section>
         <div className="absolute top-[180px] lg:top-[301px] left-[80px] lg:left-[733px] font-'Poppins' font-semibold text-[#000000] text-[36px] leading-[54px]">
            Get In Touch With Us
         </div>
         <div className="hidden lg:block w-[644px] h-[48px] absolute top-[250px] lg:top-[362px] left-[60px] lg:left-[638px] font-'Poppins' font-normal text-[#9F9F9F] text-[16px] leading-[24px] text-center">
             For More Information About Our Product & Services. Please Feel Free To Drop Us An Email. Our Staff Always Be There To Help You Out. Do Not Hesitate!
         </div>
         <div className="w-[393px] h-[537px] absolute top-[300px] lg:top-[492px] lg:left-[431px]">
         ...
         <div className="w-[623px] h-[923px] absolute top-[650px] lg:top-[424px] lg:left-[854px]">
            <div className="w-[530px] h-[121px] absolute top-[119px] left-[53px]">
                ...
                <input placeholder="Abc" className="absolute top-[35px] w-[400px] lg:w-[528px] h-[75px] rounded-[10px] border border-[#9F9F9F]"></input>
            </div>
            <div className="w-[530px] h-[121px] absolute top-[276px] left-[53px]">
                ...
                <input placeholder="Abc@def.com" className="absolute top-[35px] w-[400px] lg:w-[528px] h-[75px] rounded-[10px] border border-[#9F9F9F]"></input>
            </div>
            <div className="w-[530px] h-[121px] absolute top-[433px] left-[53px]">
                ...
                <input placeholder="This is an optional" className="absolute top-[35px] w-[400px] lg:w-[528px] h-[75px] rounded-[10px] border border-[#9F9F9F]"></input>
            </div>
            <div className="w-[530px] h-[121px] absolute top-[590px] left-[53px]">
                ...
                <input placeholder="Hi! i’d like to ask about" className="absolute top-[35px] w-[400px] lg:w-[528px] h-[120px] rounded-[10px] border border-[#9F9F9F]"></input>
            </div>
         ...
         <div className="w-[1320px] h-[270px] top-[1600px] lg:top-[1347px] left-[100px] lg:left-[300px] grid gap-[55px] lg:flex justify-between pt-[100px] pb-[100px] absolute">
